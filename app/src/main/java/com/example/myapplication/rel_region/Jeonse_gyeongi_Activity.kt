...
import com.example.myapplication.databinding.ActivityJeonseGyeongiBinding
import com.example.myapplication.databinding.ActivityJeonseSeoulBinding
...
import com.example.myapplication.relboard.RelListViewAdapter
import com.example.myapplication.relboard.RelModel
...
class Jeonse_gyeongi_Activity : AppCompatActivity() {


    private lateinit var binding: ActivityJeonseGyeongiBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_jeonse_gyeongi)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Jeonse_gyeongi_Activity, BoardInsideActivity2::class.java)
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (dataModel in dataSnapshot.children) {
                    ...
                    if (item != null) {
                        ...
                        if (item.building == "전세" && item.rent == "경기") {
