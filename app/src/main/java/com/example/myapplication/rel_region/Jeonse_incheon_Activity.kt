...
import com.example.myapplication.databinding.ActivityJeonseIncheonBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Jeonse_incheon_Activity : AppCompatActivity() {
    private lateinit var binding: ActivityJeonseIncheonBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_jeonse_incheon)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Jeonse_incheon_Activity, BoardInsideActivity2::class.java)
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (dataModel in dataSnapshot.children) {
                    ...
                    if (item != null) {
                        ...
                        if (item.building == "전세" && item.rent == "인천") {
