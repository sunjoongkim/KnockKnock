...
class Month_seoul_Activity : AppCompatActivity() {
    private lateinit var binding: ActivityMonthSeoulBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_month_seoul)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
                val intent = Intent(this@Month_seoul_Activity, BoardInsideActivity2::class.java)
        ...
        val postListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (dataModel in dataSnapshot.children) {
                    ...
                    if (item != null && item.building == "월세" && item.rent == "서울") {
