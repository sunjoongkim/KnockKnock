package com.example.myapplication.rel_build
...
import com.example.myapplication.databinding.ActivityOneRoomSeoulBinding
import com.example.myapplication.databinding.ActivityRelRandomBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Rel_Random_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityRelRandomBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_rel_random)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Rel_Random_Activity, BoardInsideActivity2::class.java)
    ...
    private fun getFBBoardData() {
        val postListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                boardDataList.clear()
                val allItems = mutableListOf<BoardModel2>()
                ...
                val selectedItems = allItems.take(10)

                // Add the selected items to the main list
                boardDataList.addAll(selectedItems)
