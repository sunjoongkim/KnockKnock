...
import com.example.myapplication.databinding.ActivityComplexHelthBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Complex_helth_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityComplexHelthBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_complex_helth)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Complex_helth_Activity, BoardInsideActivity2::class.java)
