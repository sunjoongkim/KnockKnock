...
import com.example.myapplication.databinding.ActivityComplexRestBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Complex_Rest_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityComplexRestBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_complex_rest)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Complex_Rest_Activity, BoardInsideActivity2::class.java)
