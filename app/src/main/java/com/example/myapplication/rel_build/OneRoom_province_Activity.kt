...
import com.example.myapplication.databinding.ActivityApartGyeongiBinding
import com.example.myapplication.databinding.ActivityOneRoomProvinceBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class OneRoom_province_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityOneRoomProvinceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_one_room_province)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@OneRoom_province_Activity, BoardInsideActivity2::class.java)
