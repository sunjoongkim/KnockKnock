...
import com.example.myapplication.databinding.ActivityOfficeIncheonBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Office_incheon_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityOfficeIncheonBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_office_incheon)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Office_incheon_Activity, BoardInsideActivity2::class.java)
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (dataModel in dataSnapshot.children) {
                    ...
                    if (item != null) {
                        ...
                        if (item.renum == "오피스텔" && item.rent == "인천") {
