...
import com.example.myapplication.databinding.ActivityApartIncheonBinding
...
class Apart_incheon_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityApartIncheonBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_apart_incheon)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Apart_incheon_Activity, BoardInsideActivity2::class.java)
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (dataModel in dataSnapshot.children) {
                    ...
                    if (item != null) {
                        ...
                        if (item.renum == "아파트" && item.rent == "인천") {
