...
import com.example.myapplication.databinding.ActivityOfficeGyeongiBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Office_gyeongi_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityOfficeGyeongiBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_office_gyeongi)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Office_gyeongi_Activity, BoardInsideActivity2::class.java)
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (dataModel in dataSnapshot.children) {
                    ...
                    if (item != null) {
                        ...
                        if (item.renum == "오피스텔" && item.rent == "경기") {
