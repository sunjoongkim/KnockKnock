...
import com.example.myapplication.databinding.ActivityOneRoomIncheonBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class OneRoom_incheon_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityOneRoomIncheonBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_one_room_incheon)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@OneRoom_incheon_Activity, BoardInsideActivity2::class.java)
