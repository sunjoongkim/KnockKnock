...
import com.example.myapplication.databinding.ActivityComplexShoppingBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Complex_shopping_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityComplexShoppingBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_complex_shopping)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Complex_shopping_Activity, BoardInsideActivity2::class.java)
