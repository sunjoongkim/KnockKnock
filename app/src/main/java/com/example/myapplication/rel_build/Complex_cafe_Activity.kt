...
class Complex_cafe_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityComplexCafeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_complex_cafe)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Complex_cafe_Activity, BoardInsideActivity2::class.java)
