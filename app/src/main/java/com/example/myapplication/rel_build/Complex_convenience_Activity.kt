...
import com.example.myapplication.databinding.ActivityComplexCafeBinding
import com.example.myapplication.databinding.ActivityComplexConvenienceBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Complex_convenience_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityComplexConvenienceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_complex_convenience)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Complex_convenience_Activity, BoardInsideActivity2::class.java)
