...
import com.example.myapplication.databinding.ActivityComplexPlayBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Complex_play_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityComplexPlayBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_complex_play)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Complex_play_Activity, BoardInsideActivity2::class.java)
