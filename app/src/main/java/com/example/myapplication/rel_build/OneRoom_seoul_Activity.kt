...
class OneRoom_seoul_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityOneRoomSeoulBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_one_room_seoul)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@OneRoom_seoul_Activity, BoardInsideActivity2::class.java)
