...
import com.example.myapplication.databinding.ActivityApartProvinceBinding
...
class Apart_province_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityApartProvinceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_apart_province)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Apart_province_Activity, BoardInsideActivity2::class.java)
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (dataModel in dataSnapshot.children) {
                    ...
                    if (item != null) {
                        ...
                        if (item.renum == "아파트" && item.rent == "지방") {
