...
import com.example.myapplication.databinding.ActivityOneRoomGyeongiBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class OneRoom_gyeongi_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityOneRoomGyeongiBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_one_room_gyeongi)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@OneRoom_gyeongi_Activity, BoardInsideActivity2::class.java)
