...
import com.example.myapplication.databinding.ActivityOneRoomBinding
import com.example.myapplication.databinding.ActivitySeoul2Binding
import com.example.myapplication.databinding.ActivitySeoulBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Seoul_Activity : AppCompatActivity() {

    private lateinit var binding: ActivitySeoul2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_seoul2)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Seoul_Activity, BoardInsideActivity2::class.java)
