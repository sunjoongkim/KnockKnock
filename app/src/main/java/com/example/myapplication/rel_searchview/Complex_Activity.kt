...
import com.example.myapplication.databinding.ActivityApartBinding
import com.example.myapplication.databinding.ActivityComplexBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Complex_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityComplexBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_complex)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Complex_Activity, BoardInsideActivity2::class.java)
