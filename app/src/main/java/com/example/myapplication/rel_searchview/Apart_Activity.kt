...
class Apart_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityApartBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_apart)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Apart_Activity, BoardInsideActivity2::class.java)
