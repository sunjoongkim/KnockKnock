...
class Gyeongi_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityGyeongiBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_gyeongi)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Gyeongi_Activity, BoardInsideActivity2::class.java)
