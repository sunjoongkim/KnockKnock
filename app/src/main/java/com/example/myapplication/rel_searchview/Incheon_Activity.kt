...
import com.example.myapplication.databinding.ActivityIncheonBinding
import com.example.myapplication.utils.FBRef
import com.google.firebase.database.DataSnapshot
import com.google.firebase.database.DatabaseError
import com.google.firebase.database.ValueEventListener

class Incheon_Activity : AppCompatActivity() {

    private lateinit var binding: ActivityIncheonBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_incheon)
        ...
        binding.relListView.setOnItemClickListener { parent, view, position, id ->
            val intent = Intent(this@Incheon_Activity, BoardInsideActivity2::class.java)
